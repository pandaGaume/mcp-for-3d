        ...
        return [
            ...
            // -----------------------------------------------------------------
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        name: {
                            type: "string",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightCreateFn, "name", "Name for the new light. Must be unique in the scene."),
                        },
                        position: {
                            ...vec3,
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightCreateFn,
                                "position",
                                "World-space position (right-handed y-up). Required for point and spot."
                            ),
                        },
                        direction: {
                            ...vec3,
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightCreateFn,
                                "direction",
                                "Direction vector (right-handed y-up). Required for directional, spot, and hemispheric."
                            ),
                        },
                        angle: {
                            type: "number",
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightCreateFn,
                                "angle",
                                "Cone half-angle in degrees. Required for spot. Must be in (0, 90)."
                            ),
                        },
                        exponent: {
                            type: "number",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightCreateFn, "exponent", "Falloff exponent. Spot only, optional (default 2)."),
                        },
                        ...
                        diffuseColor: {
                            ...color3,
                            description: this._resolvePropertyDescription(McpLightBehavior.LightCreateFn, "diffuseColor", "Initial diffuse color (default white)."),
                        },
                        specularColor: {
                            ...color3,
                            description: this._resolvePropertyDescription(McpLightBehavior.LightCreateFn, "specularColor", "Initial specular color (default white)."),
                        },
                        groundColor: {
                            ...color3,
                            description: this._resolvePropertyDescription(McpLightBehavior.LightCreateFn, "groundColor", "Initial ground color. Hemispheric only, optional."),
                        },
                        range: {
                            type: "number",
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightCreateFn,
                                "range",
                                "Effective range in world units. Point and spot only, optional."
                            ),
                        },
                    },
            ...
            // -----------------------------------------------------------------
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        enabled: {
                            type: "boolean",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightSetEnabledFn, "enabled", "True to enable the light, false to disable it."),
                        },
                    },
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the intensity (brightness multiplier) of a light. Default is 1. Values above 1 overbrighten."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
                        ...
                        intensity: {
                            type: "number",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightSetIntensityFn, "intensity", "New intensity. Must be >= 0."),
                        },
                    },
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the specular (highlight) color emitted by a light. Channels are in [0, 1]."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
            ...
            // -----------------------------------------------------------------
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        position: {
                            ...vec3,
                            description: this._resolvePropertyDescription(McpLightBehavior.LightSetPositionFn, "position", "New world-space position (right-handed y-up)."),
                        },
                    },
                    ...
                    properties: {
                        ...
                        direction: {
                            ...
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightSetDirectionFn,
                                "direction",
                                "New direction vector (right-handed y-up). Will be normalised."
                            ),
                        },
                    },
                    ...
                    properties: {
                        ...
                        target: {
                            ...
                            description: this._resolvePropertyDescription(
                                McpLightBehavior.LightSetTargetFn,
                                "target",
                                "World-space point to aim the light at (right-handed y-up)."
                            ),
                        },
                    },
                    required: ["uri", "target"],
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the cone half-angle of a spot light in degrees. Smaller angle = tighter, more focused beam. Only applicable to spot lights."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
                        ...
                        angle: {
                            type: "number",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightSpotSetAngleFn, "angle", "Cone half-angle in degrees. Must be in (0, 90)."),
                        },
                    },
                    required: ["uri", "angle"],
                    additionalProperties: false,
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the falloff exponent of a spot light. Higher values concentrate the light toward the cone axis. Only applicable to spot lights."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
                        ...
                        exponent: {
                            type: "number",
                            description: this._resolvePropertyDescription(McpLightBehavior.LightSpotSetExponentFn, "exponent", "Falloff exponent. Must be >= 0."),
                        },
                    },
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the ground (bottom hemisphere) color of a hemispheric light. Channels are in [0, 1]. Only applicable to hemispheric lights."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Returns the current scene-level ambient light: enabled state and color (r, g, b in [0, 1])."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Sets the scene ambient color (scene.ambientColor). Affects all materials that use ambient. Channels are in [0, 1]."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
            ...
            // -----------------------------------------------------------------
            {
                ...
                description: this._resolveToolDescription(
                    ...
                    "Enables or disables scene ambient lighting. When disabled, scene.ambientColor is set to black; the previous color is restored when re-enabled."
                ),
                inputSchema: {
                    type: "object",
                    properties: {
                        ...
                        enabled: {
                            type: "boolean",
                            description: this._resolvePropertyDescription(McpLightBehavior.SceneSetAmbientEnabledFn, "enabled", "True to enable ambient, false to disable."),
                        },
                    },
                    required: ["uri", "enabled"],
                    additionalProperties: false,
                    ...
                    properties: {
                        ...
                        patch: {
                            ...
                            properties: {
                                ...
                                position: {
                                    ...vec3,
                                    description: this._resolvePropertyDescription(McpLightBehavior.LightUpdateFn, "patch.position", "point, spot, directional (shadow frustum)."),
                                },
                                direction: {
                                    ...vec3,
                                    description: this._resolvePropertyDescription(McpLightBehavior.LightUpdateFn, "patch.direction", "directional, spot, hemispheric."),
                                },
                                ...
                                angle: {
                                    type: "number",
                                    description: this._resolvePropertyDescription(McpLightBehavior.LightUpdateFn, "patch.angle", "Spot only. Cone half-angle in degrees."),
                                },
                                exponent: {
                                    type: "number",
                                    description: this._resolvePropertyDescription(McpLightBehavior.LightUpdateFn, "patch.exponent", "Spot only. Falloff exponent."),
                                },
                                groundColor: {
                                    ...color3,
                                    description: this._resolvePropertyDescription(McpLightBehavior.LightUpdateFn, "patch.groundColor", "Hemispheric only. Ground color."),
                                },
                            },
                            additionalProperties: false,
                        },
